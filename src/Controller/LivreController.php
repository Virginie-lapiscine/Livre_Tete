...
class LivreController extends AbstractController
{
    private $profiles = [
        ...
        0 => [
              ...
              'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/Barot_Bellingham_tn.jpg'
            ],
        1 => [
                ...
                'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/Jonathan_Ferrar_tn.jpg'
            ],
        2 => [
                ...
                'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/Hillary_Goldwynn_tn.jpg'
            ],
        3 => [
                'name' => 'Hassum Harrod',
                ...
                'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/Hassum_Harrod_tn.jpg'
            ],
        4 =>
             [
                ...
                'bio' => 'A native of New Orleans, much of Jennifer\'s work has centered around abstract images that depict flooding and rebuilding, having grown up as a teenager in the post-flood years. Despite the sadness of devastation and lives lost, Jennifer\'s work also depicts the hope and togetherness of a community that has persevered. Jennifer\'s exhibit will be discussed during Tuesday\'s Water in Art theme.',
                 'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/Jennifer_Jerome_tn.jpg'
            ],
        5 => [
                ...
                'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/LaVonne_LaRue_tn.jpg'
            ],
        6 => [
                ...
                'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/Constance_Smith_tn.jpg'
            ],
        7 => [
                ...
                'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/Riley_Rewington_tn.jpg'
            ],
        8 => [
                'name' => 'Xhou Ta',
                'shortname' => 'Xhou_Ta',
                ...
                'image' => 'http://www.miteshsevani.com/roax-accademy/images/artists/Xhou_Ta_tn.jpg'
            ]
    ];


    /**
     * @Route("/livre", name="accueil_livre")
     *
     * retourne page html accueil avec les valeurs issues de $profiles
     */
    public function homeView(){
        $last_profiles = array_slice($this->profiles, -2);
        return $this->render('LivreTete/accueil.html.twig',
            [
                'profiles' => $this->profiles,
                'derniers' => $last_profiles
            ]
        );
    }

    /**
     * @Route("/profiles", name="list_profiles")
     *
     * retourne page html compilée de list_profile.html.twig
     * avec pour paramètre le tableau $profiles
     */
    public function getProfiles(){
        return $this->render('LivreTete/list_profiles.html.twig',
            [
                'profiles' => $this->profiles
            ]
        );
     ...
     *
     * retourne page html compilée du fichier twig 'profile'
     * avec pour paramètre les éléments du profil sélectionné $id
     */
    public function showProfile($id){

        return $this->render('LivreTete/profile.html.twig',
            [
                'profiles' => $this->profiles,
    ...
    public function contactForm(){
        ...
        return $this->render('LivreTete/contact.html.twig',
            [
                'profiles' => $this->profiles
            ]
        );
